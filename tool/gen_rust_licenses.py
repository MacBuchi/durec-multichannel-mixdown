...
* Workspace members (our own crates) are skipped; Mixstack's own licence is
...
def build() -> str:
    ...
    lines = [
        "Third-party licences of the Rust engine bundled with Mixstack",
        "",
        "Generated by tool/gen_rust_licenses.py from the link-time dependency",
        "graph (cargo tree -e normal --target all). Mixstack's own licence is",
